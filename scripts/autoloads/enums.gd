...
enum GamePlayState { FREEWALK, RELOADING, SHOOTING, CHANGING_WEAPON, PAUSED, OPTIONS, PLAY, TITLE,WIN, IN_DIALOG, DIED}
...
enum ButtonTipology { PLAY, OPTIONS, BACK, COMAND_LIST, AUDIO_SETTINGS, PLAY_SETTINGS, TOGGLE_FULL_SCREEN, ADVANCE_SLIDE, TITLE_SCREEN, CREDITS, EXIT, ADVANCE_LEVEL }
